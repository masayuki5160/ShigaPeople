...
import NewsModel from './TakashimaNewsModel';
import {convertToViewData} from './TakashimaNewsViewData';
...
export default class TakashimaNewsViewModel extends React.Component<Props, State> {
