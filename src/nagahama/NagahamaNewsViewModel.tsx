...
import NewsModel from './NagahamaNewsModel'
import { convertToViewData } from './NagahamaNewsViewData'
...
export default class NagahamaNewsViewModel extends React.Component<Props, State> {
