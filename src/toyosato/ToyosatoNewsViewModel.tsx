...
import NewsModel from './ToyosatoNewsModel';
import { convertToViewData } from './ToyosatoNewsViewData';
...
export default class ToyosatoNewsViewModel extends React.Component<Props, State> {
